...
class TabelaUtentes(db: SQLiteDatabase) {
    ...
    fun cria() {
        db.execSQL("CREATE TABLE $NOME_TABELA (${BaseColumns._ID} INTEGER PRIMARY KEY AUTOINCREMENT, $CAMPO_NOME_UTENTE TEXT NOT NULL, $CAMPO_DATA_NASCIMENTO TEXT NOT NULL, $CAMPO_NR_UTENTE NUMERIC NOT NULL, FOREIGN KEY($CAMPO_ID_SINTOMAS) REFERENCES ${TabelaSintomas.NOME_TABELA})")
    }
